...
export class VehiclesComponent {
  ...
  getOwnerInformation(registrationNumber: string): void {
    this.vehiclesService.getOwnerIdByRegistrationNumber(registrationNumber)
      .subscribe(ownerId => {
        this.vehiclesService.getOwnerById(ownerId)
          .subscribe(owner => {
            this.ownerDetails = owner;
            console.log('Owner details:', this.ownerDetails.email);
          }, error => {
            console.log('Error retrieving owner:', error);
          });
      }, error => {
  ...
  showOwner(vehicle: any) {
    ...
    this.vehicleMatricule = vehicle.registrationNumber;
  
    this.vehiclesService.getOwnerIdByRegistrationNumber(vehicle.registrationNumber).subscribe(
      (ownerId: number) => {
